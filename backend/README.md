...
## Project Structure
    ...
    ├── testapiautoconnecto_60393  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_60393`
...
2. Clone this repo and `cd testapiautoconnecto_60393`
